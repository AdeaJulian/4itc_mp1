    ...
    <div className="i">
        <div className="i-left">
            <div className="i-left-wrapper">
                ...
                <h1 className="i-name">Julian Simon Adea</h1>
                ...
                Santo Tomas looking to broaden my
                experience in the field of technology.
                I am a willing learner who gives their
                best in any tasks given to me.
          </p>
        </div>
        <svg
          width="75"
